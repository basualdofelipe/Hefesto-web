...
- [x] 12.7-02-PLAN.md — hefesto-front sweep: package identity + docs + 4 test fixtures, suite green (reqs 2,4,5,6)
- [x] 12.7-03-PLAN.md — root docs + .planning principal set (root docs + codebase/*) sweep; phases/* excluded per D-03 (reqs 4,7)

**Wave 2** *(blocked on Wave 1)*

- [x] 12.7-04-PLAN.md — follow-up checklist doc (GitHub renames + D-04 folder/.gitignore + D-05 exclusion) + final cross-repo acceptance roll-up (reqs 1,4,7)
...
- [x] 12.6-03-PLAN.md -- Front branding: constants/branding.ts + layout title + 3 alt + acceso-denegado (heading/texto/contacto) + DemoLoginButton (R1,R4,R10)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 12.6-02-PLAN.md -- Back seed-from-env: CreateUserTable (admin) + SeedDemoUser (demo) parametrizados + [BLOCKING] migration:run en DB fresca (R5,R9)
...
- [x] 12.5-04-PLAN.md — error.tsx/loading.tsx boundaries + slug constants + process-comment cleanup (R8, R9, R10)
- [x] 12.5-05-PLAN.md — Frontend Credentials provider + "Entrar como demo" button (R2)
- [x] 12.5-06-PLAN.md — Demo-user seed migration (R3)
...
- [x] 12.4-08-PLAN.md — Gap closure: fix last-admin guard SQL crash (FOR UPDATE+aggregate) + transferOwnership entity-property bug (updated_at→updatedAt) + real-Postgres regression coverage
...
- [x] 12.2-02-PLAN.md — Frontend UX: home page cards, logo PNG sidebar/login, cascade collapse defaults, table alignment, toast fix
- [x] 12.2-03-PLAN.md — Typography audit: replace all font-medium/font-bold with font-semibold/font-normal across 23 app files
...
- [x] 12.1-04-PLAN.md — Roles management UI: /roles page with table + create/edit/delete dialogs, /usuarios page with dynamic role selection, visual verification
...
| 12. Scenarios | v1.1 | 3/3 | Complete   | 2026-06-17 |
| 12.1. Dynamic Roles | v1.1 | 4/4 | Complete    | 2026-04-10 |
| 12.2. UI Polish | v1.1 | 3/3 | Complete    | 2026-04-10 |
