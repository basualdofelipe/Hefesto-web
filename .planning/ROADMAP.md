...
Plans:
- [ ] 12.5-01-PLAN.md — Backend demo-login endpoint + DTO + env flag + auth.service spec (R1)
- [ ] 12.5-02-PLAN.md — Backend service specs: products, supplies, tiendanube-config (R4, R7)
